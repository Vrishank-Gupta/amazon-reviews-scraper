...
export function SentBadge({ s }) {
  const map = {
    Negative: ['#ef4444', 'rgba(239,68,68,0.12)', 'v'],
    Positive: ['#22c55e', 'rgba(34,197,94,0.12)', '^'],
    Neutral: ['#eab308', 'rgba(234,179,8,0.12)', 'o'],
  }
  const [color, bg, icon] = map[s] || ['#94a3b8', 'transparent', 'o']
...
export function Delta({ val, invertColor = false }) {
  ...
  return <span style={{ color, fontWeight: 700, fontSize: 12 }}>{text}</span>
}
