...
CREATE TABLE IF NOT EXISTS `raw_reviews` (
  ...
  `scrape_asin` VARCHAR(20) DEFAULT NULL,
  `variant_asin` VARCHAR(20) DEFAULT NULL,
  `variant_label` VARCHAR(255) DEFAULT NULL,
  `variant_dimension` VARCHAR(64) DEFAULT NULL,
  ...
  KEY `idx_raw_reviews_scrape_asin` (`scrape_asin`),
  KEY `idx_raw_reviews_variant_asin` (`variant_asin`),
  KEY `idx_raw_reviews_variant_label` (`variant_label`),
